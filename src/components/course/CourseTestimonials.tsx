...
import type { CourseTestimonialsData, CourseTestimonialData } from "@/content/courseTypes";
import { cn } from "@/lib/cn";

function TestimonialCard({ t }: { t: CourseTestimonialData }) {
  return (
...
export function CourseTestimonials({ testimonials }: { testimonials: CourseTestimonialsData }) {
