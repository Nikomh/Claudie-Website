...
import { agileFuehrungContent } from "@/content/agileFuehrung";
import { Breadcrumbs } from "@/components/ui/Breadcrumbs";
import { StickyCourseCta } from "@/components/ui/StickyCourseCTA";

export function generateMetadata(): Metadata {
  const { meta } = agileFuehrungContent;
  return {
    title: meta.title,
...
export default function AgileFuehrungPage() {
  const c = agileFuehrungContent;
  return (
    <>
      <Breadcrumbs items={[{ label: "Ausbildungen", href: "/ausbildungen" }, { label: "Agile Führung" }]} />
