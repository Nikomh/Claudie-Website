...
import { vertriebscoachContent } from "@/content/vertriebscoach";
import { Breadcrumbs } from "@/components/ui/Breadcrumbs";
import { StickyCourseCta } from "@/components/ui/StickyCourseCTA";

export function generateMetadata(): Metadata {
  const { meta } = vertriebscoachContent;
  return {
    title: meta.title,
...
export default function VertriebscoachPage() {
  const c = vertriebscoachContent;
  return (
    <>
      <Breadcrumbs items={[{ label: "Ausbildungen", href: "/ausbildungen" }, { label: "Vertriebscoach" }]} />
