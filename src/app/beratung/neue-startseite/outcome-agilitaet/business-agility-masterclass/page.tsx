...
export const metadata: Metadata = {
  title: "Business Agility Masterclass — Outcome-orientierte Lieferung · Claudia Thonet",
  description:
    "Zwei intensive Tage — agile Praxis, OKRs und KI-Workflows so verbinden, dass am Ende messbare Geschäftsergebnisse stehen und nicht nur gut laufende Prozesse.",
  robots: { index: false, follow: false },
};

const MODULES = [
  {
    title: "Business Agility — was das wirklich bedeutet",
    body: "Was Business Agility von Scrum trennt: Strategiefähigkeit, Kundennähe und Wertorientierung.",
  },
  {
    title: "Agile Praxis mit Geschäftswert verbinden",
    body: "Wie Teams und Führungsteams den Bogen von agilen Methoden zu messbaren Ergebnissen spannen.",
  },
  {
    title: "OKRs als Steuerungsinstrument",
    body: "OKRs richtig formulieren, reviewen und im Alltag nutzen — ohne sie zu einem bürokratischen Pflichttermin werden zu lassen.",
  },
  {
    title: "KI-unterstützte Planung und Entscheidung",
    body: "Wie KI bei Backlog-Priorisierung, Risikobewertung und Statusreporting hilft — ohne Kontrollverlust.",
  },
  {
    title: "Outcome-Metriken und Lernschleifen",
    body: "Welche Zahlen wirklich zählen: Leading indicators, Flow-Metriken und Business-Impact-Stories.",
  },
  {
    title: "Portfolio-Steuerung und Fokus",
    body: "Wie Organisationen zu weniger Gleichzeitigkeit und mehr Wirkung kommen.",
  },
];

const FUER_WEN = [
  "Agile Coaches und Scrum Master mit Strategieambitionen",
  "Führungskräfte mit Lieferverantwortung",
  "Product Owner und Produktverantwortliche",
  "Teams, die OKRs und Agilität verbinden wollen",
];

const FORMAT = [
  "2 Tage",
  "Präsenz oder Live-Online",
  "Gruppenarbeit mit echten Fällen",
  "Inhouse verfügbar",
];

export default function BusinessAgilityMasterclassPage() {
  return (
    <>
      {/* BACK LINK */}
      ...
      <section className="relative overflow-hidden bg-anthrazit">
        ...
        <Container className="relative grid min-h-[540px] items-center gap-12 py-20 md:py-28 lg:grid-cols-[3fr_2fr] lg:gap-16">
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={180}>
              <p className="max-w-[52ch] text-base leading-relaxed text-white/65 md:text-lg">
                Zwei intensive Tage — agile Praxis, OKRs und KI-Workflows so verbinden, dass am Ende messbare
                Geschäftsergebnisse stehen und nicht nur gut laufende Prozesse.
              </p>
            </Reveal>
          ...
          <Reveal delay={200} className="relative hidden lg:flex lg:items-center lg:justify-center">
            <Image
              src="/images/illustrations/CT_SE02_module.png"
              alt="Business Agility Masterclass"
              width={200}
              height={200}
      ...
      <Section>
        <Container>
          <SectionHeading
            ...
            lead="Sechs Module, die Business Agility greifbar, praktisch und messbar machen."
          />
